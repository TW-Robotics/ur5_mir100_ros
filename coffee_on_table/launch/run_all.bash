...
xterm -geometry 96x24+0-0 -hold -e "rosrun coffee_on_table cupfind person cup outside" &
...
#xterm -hold -e "roslaunch ur_modern_driver ur5_bringup.launch limited:=true robot_ip:=192.168.4.120" &
#sleep 5

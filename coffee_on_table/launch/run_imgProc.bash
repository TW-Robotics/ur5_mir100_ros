...
xterm -geometry 96x24+0-0 -hold -e "rosrun coffee_on_table cupfind person cup touching" &	# Arguments: OuterClass, InnerClass, Strictness (outside, touching (means center of inner box is in outer box), inside)
#--------------------#
#--- We are done! ---#
#--------------------#

...
xterm -geometry 96x24+0-0 -hold -e "rosrun coffee_on_table img_processing cup " &	# Arguments: InnerClass, OuterClass, Strictness (outside, touching (means center of inner box is in outer box), inside)
